<div class="body-inner">
		...
		<header id="header" class="header-one">
			<div class="container">
				<div class="row">
					<div class="centers logo-area clearfix">
							...
							<div class="site-nav-inner pull-left">
								...
								<div class="collapse navbar-collapse navbar-responsive-collapse">
									...
									<ul class="nav navbar-nav">
										...
										<li><a href="contact.html">ลงชื่อ เข้าใช้งาน</a></li>
									</ul>
									<!--/ Nav ul end -->
								</div>
								<!--/ Collapse end -->
    ...
    $.get("http://localhost/website/student.php?level="+student_level, function(data, status){
    ...
    $.get("http://localhost/website/Course.php", function(data, status){
      //alert("Data: " + data + "\nStatus: " + status);
      document.getElementById("body_content_info").innerHTML = data;
    });
    }
    ...
    $.get("http://localhost/website/Remain.php", function(data, status){
      //alert("Data: " + data + "\nStatus: " + status);
      document.getElementById("body_content_info").innerHTML = data;
    });
    }
    function showDatePage(){
    $.get("http://localhost/website/date.php", function(data, status){
      //alert("Data: " + data + "\nStatus: " + status);
      document.getElementById("body_content_info").innerHTML = data;
    });
    }
